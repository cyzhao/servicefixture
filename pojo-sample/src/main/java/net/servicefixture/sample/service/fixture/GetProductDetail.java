...
import net.servicefixture.sample.service.ProductService;
 ...
 * @since Aug 26, 2006
 */
public class GetProductDetail extends PojoServiceFixture {
	@Override
	...
	protected Object getPojo() {
		return SpringContextUtil.getBean("productService");
	}
	@Override
